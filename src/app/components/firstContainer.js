...
import EffectPic from "/public/effect.png";
    ...
    return (
        <ReactLenis root>
            <motion.div
                ...
                <div className=" absolute w-full h-full mobile:w-[60vmin] mobile:h-[60vmin] ">
                    <div className={` z-[5] w-full h-full relative ${mainPicScale === 100 ? 'scale-100' : 'scale-0'} duration-300 `} >
                        <Image className=" mobile:hidden " src={EffectLogoPic} alt="biglogo" priority fill sizes="100%, 100%" />
                ...
                <div className=" w-full flex justify-end absolute bottom-20">
                    <div className=" text-white  w-[35vmax] mobile:w-full mobile:text-center text-[1.3vmax] mobile:text-[3vmin] p-6 font-semibold">
                ...
                <div className=" text-white absolute bottom-3 w-full font-bold text-[1.2vmax] mobile:text-[2vmin] flex items-center place-content-between px-[1.5%] pt-[2%]">
                    <p>OFFICIAL@IMMERSIX.XYZ</p>
                    <p className=" underline">RJ +55 21 25416887</p>
